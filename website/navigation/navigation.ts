...
export const navigation = (locale: AppLocale): NavItemDefinition[] => [
  ...
  },
  {
    ...
    slug: 'publishing',
    children: [{ slug: 'publishing-a-subgraph' }],
  },
  {
    title: translate(translations, locale, 'global.navigation.managing'),
    slug: 'managing',
    children: [{ slug: 'transferring-subgraph-ownership' }, { slug: 'deprecating-a-subgraph' }],
  },
  {
  ...
  { divider: true },
  {
    ...
    slug: 'release-notes',
    children: [{ slug: 'assemblyscript-migration-guide' }],
  },
]
